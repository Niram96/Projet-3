...
function cleanForm () {
	...
	if (document.querySelector("dialog .add-photo-div-dialog .form-add-photo .form-img-div img") !== null) {
		console.log("Ok");
		document.querySelector("dialog .add-photo-div-dialog .form-add-photo .form-img-div img").remove();
	}
	validateBtn.removeAttribute("enabled", "enabled");
	validateBtn.setAttribute("disabled", "disabled");
	validateBtn.classList.remove("validate-btn");
	validateBtn.classList.add("validate-btn-disabled");
}		
...
function homepageEdit () {
	if (window.sessionStorage.getItem("token") !== null) {
		...
		formImgInput.addEventListener("change", function () {
			...
			const imageTypesAccepted = new RegExp ("image/jpeg|image/jpg|image.png");
